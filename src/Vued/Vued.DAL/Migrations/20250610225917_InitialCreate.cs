...
namespace Vued.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "MediaFiles",
                columns: new[] { "Id", "Description", "Director", "Duration", "Favourite", "ImageURL", "MediaType", "Name", "Rating", "ReleaseDate", "Review", "Status", "URL" },
                values: new object[,]
                {
                    ...
                    { 2, "The life story of a man with a low IQ who achieves extraordinary feats through his kindness and determination.", "Robert Zemeckis", 142, true, "https://storage.googleapis.com/pod_public/1300/266241.jpg", 0, "Forrest Gump", "6/10", 1994, "Cool", 2, "https://www.imdb.com/title/tt0109830/" },
                    { 3, "A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence.", "Stanley Kubrick", 144, false, "https://storage.googleapis.com/pod_public/1300/262806.jpg", 0, "The Shining", "7/10", 1980, "Idk", 2, "https://www.imdb.com/title/tt0081505/" },
                    { 4, "A skilled thief with the ability to enter dreams must pull off an impossible heist: planting an idea in someone's mind.", "Christopher Nolan", 148, true, "https://www.vasefotka.cz/fotky22340/fotos/_vyr_271602026-Inception-Pocatek.jpg", 0, "Inception", "9/10", 2010, "Perfect", 2, "https://www.imdb.com/title/tt1375666/" },
                    ...
                    { 9, "A chemistry teacher turned drug-lord teams up with a former student to build a methamphetamine empire.", "Vince Gilligan", 62, true, "https://m.media-amazon.com/images/I/91+GrGr5TWL._AC_UF894,1000_QL80_.jpg", 1, "Breaking Bad", "10/10", 2008, "Nice", 2, "https://www.imdb.com/title/tt0903747/" },
                    { 10, "A group of friends in the 1980s uncover supernatural mysteries and government conspiracies in their small town.", "The Duffer Brothers", 34, true, "https://static.posters.cz/image/1300/132239.jpg", 1, "Stranger Things", "8/10", 2016, "Nice", 1, "https://www.imdb.com/title/tt4574334/" },
                    { 11, "A mockumentary about the daily lives of employees at the Dunder Mifflin paper company.", "Greg Daniels", 201, true, "https://m.media-amazon.com/images/M/MV5BZjQwYzBlYzUtZjhhOS00ZDQ0LWE0NzAtYTk4MjgzZTNkZWEzXkEyXkFqcGc@._V1_.jpg", 1, "The Office (US)", "9/10", 2005, "Nice", 2, "https://www.imdb.com/title/tt0386676/" },
                    { 12, "Noble families fight for control of the Iron Throne in a fantasy world filled with dragons and political intrigue.", "David Benioff, D.B. Weiss", 73, true, "https://static.posters.cz/image/1300/135455.jpg", 1, "Game of Thrones", "9/10", 2011, "Nice", 2, "https://www.imdb.com/title/tt0944947/" },
                    { 13, "A lone bounty hunter navigates the outer reaches of the galaxy, protecting a mysterious baby Yoda.", "Jon Favreau", 24, false, "https://static.posters.cz/image/750/103406.jpg", 1, "The Mandalorian", "6/10", 2019, "Nice", 1, "https://www.imdb.com/title/tt8111088/" },
                    { 14, "An anthology series exploring the dark side of technology and human nature in dystopian futures.", "Charlie Brooker", 27, false, "https://m.media-amazon.com/images/M/MV5BODcxMWI2NDMtYTc3NC00OTZjLWFmNmUtM2NmY2I1ODkxYzczXkEyXkFqcGc@._V1_.jpg", 1, "Black Mirror", "8/10", 2011, "Nice", 1, "https://www.imdb.com/title/tt2085059/" },
                    { 15, "A biographical drama chronicling the reign of Queen Elizabeth II and major historical events.", "Peter Morgan", 60, false, "https://image.tmdb.org/t/p/original/1M876KPjulVwppEpldhdc8V4o68.jpg", 1, "The Crown", "-", 2016, "Nice", 0, "https://www.imdb.com/title/tt4786824/" },
                    { 16, "The trials and tribulations of criminal lawyer Jimmy McGill in the years leading up to his fateful run-in with Walter White and Jesse Pinkman.", "Peter Gould", 63, true, "https://m.media-amazon.com/images/M/MV5BNDdjNTEzMjMtYjM3Mi00NzQ3LWFlNWMtZjdmYWU3ZDkzMjk1XkEyXkFqcGc@._V1_.jpg", 1, "Better Call Saul", "9/10", 2015, "Nice", 2, "https://www.imdb.com/title/tt3032476/" },
                    { 17, "An internal succession war within House Targaryen at the height of its power, 172 years before the birth of Daenerys Targaryen.", "Ryan J. Condal", 60, true, "https://m.media-amazon.com/images/M/MV5BYjBhMTU2N2EtYjVkYS00ODBiLTk3MDUtYWFmZTM2M2JkNzcwXkEyXkFqcGc@._V1_.jpg", 1, "The House of the Dragon", "9/10", 2021, "Nice", 2, "https://www.imdb.com/title/tt11198330/" }
                });
